...
psql -v ON_ERROR_STOP=1 -h localhost -U geco -d ${database_name} -f ${virusurf_dir}sql_scripts/epitope_tables/refresh_table/refresh_sars_cov_2.sql | tee -a $log_file_path
check_exit_code "${PIPESTATUS[0]}"
