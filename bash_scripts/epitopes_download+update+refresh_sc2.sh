...
# Delete old epitopes
echo "* Deletion of previous SC2 epitopes..." | tee -a $log_file_path
cd $virusurf_dir
...
echo "* Refresh SC2 eptiope variants and info materialized view"
psql -h localhost -U geco -d ${database_name} -c "
...
echo "* Update of SC2 epitopes completed on database ${database_name}." | tee -a $log_file_path