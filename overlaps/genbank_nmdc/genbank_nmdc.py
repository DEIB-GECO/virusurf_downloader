...
def mark_overlaps():
    ...
    try:
        for source_seq in tqdm(source_sequences(session, database_source=source_database_source, virus_taxon_name='Severe acute respiratory syndrome coronavirus 2')):
