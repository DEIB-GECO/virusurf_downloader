...
INSERT INTO public.epitope_186540_nucleoprotein (
    iedb_epitope_id,
    epitope_iri,
    cell_type,
    mhc_class,
...
-- with postgres limit on DB object names (max 63 chars allowed) on views, tables, constraints and indexes.
INSERT INTO public.epitope_186540_polymerase_complex_protein (
    iedb_epitope_id,
    epitope_iri,
    cell_type,
    mhc_class,
...
-- with postgres limit on DB object names (max 63 chars allowed) on views, tables, constraints and indexes.
INSERT INTO public.epitope_186540_matrix_protein (
    iedb_epitope_id,
    epitope_iri,
    cell_type,
    mhc_class,
...
-- with postgres limit on DB object names (max 63 chars allowed) on views, tables, constraints and indexes.
INSERT INTO public.epitope_186540_spike_glycoprotein (
    iedb_epitope_id,
    epitope_iri,
    cell_type,
    mhc_class,
...
-- with postgres limit on DB object names (max 63 chars allowed) on views, tables, constraints and indexes.
INSERT INTO public.epitope_186540_small_secreted_glycoprotein (
    iedb_epitope_id,
    epitope_iri,
    cell_type,
    mhc_class,
...
-- with postgres limit on DB object names (max 63 chars allowed) on views, tables, constraints and indexes.
INSERT INTO public.epitope_186540_second_secreted_glycoprotein (
    iedb_epitope_id,
    epitope_iri,
    cell_type,
    mhc_class,
...
-- with postgres limit on DB object names (max 63 chars allowed) on views, tables, constraints and indexes.
INSERT INTO public.epitope_186540_minor_nucleoprotein (
    iedb_epitope_id,
    epitope_iri,
    cell_type,
    mhc_class,
...
-- with postgres limit on DB object names (max 63 chars allowed) on views, tables, constraints and indexes.
INSERT INTO public.epitope_186540_membrane_associated_protein (
    iedb_epitope_id,
    epitope_iri,
    cell_type,
    mhc_class,
...
-- with postgres limit on DB object names (max 63 chars allowed) on views, tables, constraints and indexes.
INSERT INTO public.epitope_186540_rna_dependent_rna_polymerase (
    iedb_epitope_id,
    epitope_iri,
    cell_type,
    mhc_class,
