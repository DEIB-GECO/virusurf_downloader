...
-- JOIN KEY
CREATE INDEX nucleotide_variant_annotated__sequence_id__idx ON nucleotide_variant_annotated USING btree (sequence_id) WITH (FILLFACTOR = 100) TABLESPACE default_ts;
