...
--
-- Name: epitope_11053_envelope_pr; Type: MATERIALIZED VIEW; Schema: public; Owner: geco
--

CREATE MATERIALIZED VIEW public.epitope_11053_envelope_pr AS
 SELECT DISTINCT epi.iedb_epitope_id,
  ...
  WHERE (((epi.protein_name)::text = (ann.product)::text) AND (amin.start_aa_original <= epif.epi_frag_annotation_stop) AND (amin.start_aa_original >= epif.epi_frag_annotation_start) AND ((ann.product)::text = 'envelope protein E'::text) AND ((epi.protein_name)::text = 'envelope protein E'::text) AND (vir.taxon_id = 11053))
  ORDER BY epi.iedb_epitope_id
  WITH NO DATA;


ALTER TABLE public.epitope_11053_envelope_pr OWNER TO geco;

--
-- Name: epitope_11053_polyprotein; Type: MATERIALIZED VIEW; Schema: public; Owner: geco
--

CREATE MATERIALIZED VIEW public.epitope_11053_polyprotein AS
 SELECT DISTINCT epi.iedb_epitope_id,
    epi.epitope_iri,
    epi.cell_type,
    epi.mhc_class,
   ...
   FROM (((((((public.epitope epi
     ...
     JOIN public.annotation ann ON ((seq.sequence_id = ann.sequence_id)))
     JOIN public.aminoacid_variant amin ON ((ann.annotation_id = amin.annotation_id)))
  WHERE (((epi.protein_name)::text = (ann.product)::text) AND (amin.start_aa_original <= epif.epi_frag_annotation_stop) AND (amin.start_aa_original >= epif.epi_frag_annotation_start) AND ((ann.product)::text = 'polyprotein'::text) AND ((epi.protein_name)::text = 'polyprotein'::text) AND (vir.taxon_id = 11053))
  ORDER BY epi.iedb_epitope_id
  WITH NO DATA;


ALTER TABLE public.epitope_11053_polyprotein OWNER TO geco;

--
-- Name: epitope_11060_envelope_pr; Type: MATERIALIZED VIEW; Schema: public; Owner: geco
--

CREATE MATERIALIZED VIEW public.epitope_11060_envelope_pr AS
 SELECT DISTINCT epi.iedb_epitope_id,
    epi.epitope_iri,
    epi.cell_type,
    epi.mhc_class,
   ...
   FROM (((((((public.epitope epi
     ...
     JOIN public.annotation ann ON ((seq.sequence_id = ann.sequence_id)))
     JOIN public.aminoacid_variant amin ON ((ann.annotation_id = amin.annotation_id)))
  WHERE (((epi.protein_name)::text = (ann.product)::text) AND (amin.start_aa_original <= epif.epi_frag_annotation_stop) AND (amin.start_aa_original >= epif.epi_frag_annotation_start) AND ((ann.product)::text = 'envelope protein E'::text) AND ((epi.protein_name)::text = 'envelope protein E'::text) AND (vir.taxon_id = 11060))
  ORDER BY epi.iedb_epitope_id
  WITH NO DATA;


ALTER TABLE public.epitope_11060_envelope_pr OWNER TO geco;

--
-- Name: epitope_11060_polyprotein; Type: MATERIALIZED VIEW; Schema: public; Owner: geco
--

CREATE MATERIALIZED VIEW public.epitope_11060_polyprotein AS
 SELECT DISTINCT epi.iedb_epitope_id,
    epi.epitope_iri,
    epi.cell_type,
    epi.mhc_class,
   ...
   FROM (((((((public.epitope epi
     ...
     JOIN public.annotation ann ON ((seq.sequence_id = ann.sequence_id)))
     JOIN public.aminoacid_variant amin ON ((ann.annotation_id = amin.annotation_id)))
  WHERE (((epi.protein_name)::text = (ann.product)::text) AND (amin.start_aa_original <= epif.epi_frag_annotation_stop) AND (amin.start_aa_original >= epif.epi_frag_annotation_start) AND ((ann.product)::text = 'polyprotein'::text) AND ((epi.protein_name)::text = 'polyprotein'::text) AND (vir.taxon_id = 11060))
  ORDER BY epi.iedb_epitope_id
  WITH NO DATA;


ALTER TABLE public.epitope_11060_polyprotein OWNER TO geco;

--
-- Name: epitope_11069_envelope_pr; Type: MATERIALIZED VIEW; Schema: public; Owner: geco
--

CREATE MATERIALIZED VIEW public.epitope_11069_envelope_pr AS
 SELECT DISTINCT epi.iedb_epitope_id,
    epi.epitope_iri,
    epi.cell_type,
    epi.mhc_class,
   ...
   FROM (((((((public.epitope epi
     ...
     JOIN public.annotation ann ON ((seq.sequence_id = ann.sequence_id)))
     JOIN public.aminoacid_variant amin ON ((ann.annotation_id = amin.annotation_id)))
  WHERE (((epi.protein_name)::text = (ann.product)::text) AND (amin.start_aa_original <= epif.epi_frag_annotation_stop) AND (amin.start_aa_original >= epif.epi_frag_annotation_start) AND ((ann.product)::text = 'envelope protein E'::text) AND ((epi.protein_name)::text = 'envelope protein E'::text) AND (vir.taxon_id = 11069))
  ORDER BY epi.iedb_epitope_id
  WITH NO DATA;


ALTER TABLE public.epitope_11069_envelope_pr OWNER TO geco;

--
-- Name: epitope_11069_polyprotein; Type: MATERIALIZED VIEW; Schema: public; Owner: geco
--

CREATE MATERIALIZED VIEW public.epitope_11069_polyprotein AS
 SELECT DISTINCT epi.iedb_epitope_id,
    epi.epitope_iri,
    epi.cell_type,
    epi.mhc_class,
   ...
   FROM (((((((public.epitope epi
     ...
     JOIN public.annotation ann ON ((seq.sequence_id = ann.sequence_id)))
     JOIN public.aminoacid_variant amin ON ((ann.annotation_id = amin.annotation_id)))
  WHERE (((epi.protein_name)::text = (ann.product)::text) AND (amin.start_aa_original <= epif.epi_frag_annotation_stop) AND (amin.start_aa_original >= epif.epi_frag_annotation_start) AND ((ann.product)::text = 'polyprotein'::text) AND ((epi.protein_name)::text = 'polyprotein'::text) AND (vir.taxon_id = 11069))
  ORDER BY epi.iedb_epitope_id
  WITH NO DATA;


ALTER TABLE public.epitope_11069_polyprotein OWNER TO geco;

--
-- Name: epitope_11070_envelope_pr; Type: MATERIALIZED VIEW; Schema: public; Owner: geco
--

CREATE MATERIALIZED VIEW public.epitope_11070_envelope_pr AS
 SELECT DISTINCT epi.iedb_epitope_id,
    epi.epitope_iri,
    epi.cell_type,
    epi.mhc_class,
   ...
   FROM (((((((public.epitope epi
     ...
     JOIN public.annotation ann ON ((seq.sequence_id = ann.sequence_id)))
     JOIN public.aminoacid_variant amin ON ((ann.annotation_id = amin.annotation_id)))
  WHERE (((epi.protein_name)::text = (ann.product)::text) AND (amin.start_aa_original <= epif.epi_frag_annotation_stop) AND (amin.start_aa_original >= epif.epi_frag_annotation_start) AND ((ann.product)::text = 'envelope protein E'::text) AND ((epi.protein_name)::text = 'envelope protein E'::text) AND (vir.taxon_id = 11070))
  ORDER BY epi.iedb_epitope_id
  WITH NO DATA;


ALTER TABLE public.epitope_11070_envelope_pr OWNER TO geco;

--
-- Name: epitope_11070_polyprotein; Type: MATERIALIZED VIEW; Schema: public; Owner: geco
--

CREATE MATERIALIZED VIEW public.epitope_11070_polyprotein AS
 SELECT DISTINCT epi.iedb_epitope_id,
    epi.epitope_iri,
    epi.cell_type,
    epi.mhc_class,
   ...
   FROM (((((((public.epitope epi
     ...
     JOIN public.annotation ann ON ((seq.sequence_id = ann.sequence_id)))
     JOIN public.aminoacid_variant amin ON ((ann.annotation_id = amin.annotation_id)))
  WHERE (((epi.protein_name)::text = (ann.product)::text) AND (amin.start_aa_original <= epif.epi_frag_annotation_stop) AND (amin.start_aa_original >= epif.epi_frag_annotation_start) AND ((ann.product)::text = 'polyprotein'::text) AND ((epi.protein_name)::text = 'polyprotein'::text) AND (vir.taxon_id = 11070))
  ORDER BY epi.iedb_epitope_id
  WITH NO DATA;


ALTER TABLE public.epitope_11070_polyprotein OWNER TO geco;
...
--
-- Name: epi_11053_envelope_pr__cell_type__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11053_envelope_pr__cell_type__idx ON public.epitope_11053_envelope_pr USING btree (((cell_type)::text)) WITH (fillfactor='100');


--
-- Name: epi_11053_envelope_pr__epi_annotation_start__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11053_envelope_pr__epi_annotation_start__idx ON public.epitope_11053_envelope_pr USING btree (epi_annotation_start) WITH (fillfactor='100');


--
-- Name: epi_11053_envelope_pr__epi_annotation_stop__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11053_envelope_pr__epi_annotation_stop__idx ON public.epitope_11053_envelope_pr USING btree (epi_annotation_stop) WITH (fillfactor='100');


--
-- Name: epi_11053_envelope_pr__epi_frag_annotation_start__i; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11053_envelope_pr__epi_frag_annotation_start__i ON public.epitope_11053_envelope_pr USING btree (epi_frag_annotation_start) WITH (fillfactor='100');


--
-- Name: epi_11053_envelope_pr__epi_frag_annotation_stop__id; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11053_envelope_pr__epi_frag_annotation_stop__id ON public.epitope_11053_envelope_pr USING btree (epi_frag_annotation_stop) WITH (fillfactor='100');


--
-- Name: epi_11053_envelope_pr__host_taxon_id__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11053_envelope_pr__host_taxon_id__idx ON public.epitope_11053_envelope_pr USING btree (host_taxon_id) WITH (fillfactor='100');


--
-- Name: epi_11053_envelope_pr__host_taxon_name_lower__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11053_envelope_pr__host_taxon_name_lower__idx ON public.epitope_11053_envelope_pr USING btree (lower((host_taxon_name)::text)) WITH (fillfactor='100');


--
-- Name: epi_11053_envelope_pr__iedb_epitope_id__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11053_envelope_pr__iedb_epitope_id__idx ON public.epitope_11053_envelope_pr USING btree (iedb_epitope_id) WITH (fillfactor='100');


--
-- Name: epi_11053_envelope_pr__is_linear__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11053_envelope_pr__is_linear__idx ON public.epitope_11053_envelope_pr USING btree (is_linear) WITH (fillfactor='100');


--
-- Name: epi_11053_envelope_pr__mhc_allele__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11053_envelope_pr__mhc_allele__idx ON public.epitope_11053_envelope_pr USING btree (((mhc_allele)::text)) WITH (fillfactor='100');


--
-- Name: epi_11053_envelope_pr__mhc_class_lower__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11053_envelope_pr__mhc_class_lower__idx ON public.epitope_11053_envelope_pr USING btree (lower((mhc_class)::text)) WITH (fillfactor='100');


--
-- Name: epi_11053_envelope_pr__product_lower__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11053_envelope_pr__product_lower__idx ON public.epitope_11053_envelope_pr USING btree (lower((product)::text)) WITH (fillfactor='100');


--
-- Name: epi_11053_envelope_pr__response_frequency_pos__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11053_envelope_pr__response_frequency_pos__idx ON public.epitope_11053_envelope_pr USING btree (response_frequency_pos) WITH (fillfactor='100');


--
-- Name: epi_11053_envelope_pr__sequence_aa_alternative__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11053_envelope_pr__sequence_aa_alternative__idx ON public.epitope_11053_envelope_pr USING btree (((sequence_aa_alternative)::text)) WITH (fillfactor='100');


--
-- Name: epi_11053_envelope_pr__sequence_aa_original__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11053_envelope_pr__sequence_aa_original__idx ON public.epitope_11053_envelope_pr USING btree (((sequence_aa_original)::text)) WITH (fillfactor='100');


--
-- Name: epi_11053_envelope_pr__start_aa_original__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11053_envelope_pr__start_aa_original__idx ON public.epitope_11053_envelope_pr USING btree (start_aa_original) WITH (fillfactor='100');


--
-- Name: epi_11053_envelope_pr__taxon_id__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11053_envelope_pr__taxon_id__idx ON public.epitope_11053_envelope_pr USING btree (taxon_id) WITH (fillfactor='100');


--
-- Name: epi_11053_envelope_pr__taxon_name_lower__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11053_envelope_pr__taxon_name_lower__idx ON public.epitope_11053_envelope_pr USING btree (lower((taxon_name)::text)) WITH (fillfactor='100');


--
-- Name: epi_11053_envelope_pr__variant_aa_length__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11053_envelope_pr__variant_aa_length__idx ON public.epitope_11053_envelope_pr USING btree (variant_aa_length) WITH (fillfactor='100');


--
-- Name: epi_11053_envelope_pr__variant_aa_type__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11053_envelope_pr__variant_aa_type__idx ON public.epitope_11053_envelope_pr USING btree (((variant_aa_type)::text)) WITH (fillfactor='100');


--
-- Name: epi_11053_envelope_pr__virus_host_cell_type__i; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11053_envelope_pr__virus_host_cell_type__i ON public.epitope_11053_envelope_pr USING btree (taxon_id, host_taxon_id, cell_type) WITH (fillfactor='100');


--
-- Name: epi_11053_envelope_pr__virus_host_epi_start__i; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11053_envelope_pr__virus_host_epi_start__i ON public.epitope_11053_envelope_pr USING btree (taxon_id, host_taxon_id, epi_annotation_start) WITH (fillfactor='100');


--
-- Name: epi_11053_envelope_pr__virus_host_epi_stop__i; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11053_envelope_pr__virus_host_epi_stop__i ON public.epitope_11053_envelope_pr USING btree (taxon_id, host_taxon_id, epi_annotation_stop) WITH (fillfactor='100');


--
-- Name: epi_11053_envelope_pr__virus_host_is_linear__i; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11053_envelope_pr__virus_host_is_linear__i ON public.epitope_11053_envelope_pr USING btree (taxon_id, host_taxon_id, is_linear) WITH (fillfactor='100');


--
-- Name: epi_11053_envelope_pr__virus_host_mhc_allele__i; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11053_envelope_pr__virus_host_mhc_allele__i ON public.epitope_11053_envelope_pr USING btree (taxon_id, host_taxon_id, mhc_allele) WITH (fillfactor='100');


--
-- Name: epi_11053_envelope_pr__virus_host_product__i; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11053_envelope_pr__virus_host_product__i ON public.epitope_11053_envelope_pr USING btree (taxon_id, host_taxon_id, product) WITH (fillfactor='100');


--
-- Name: epi_11053_envelope_pr__virus_host_resp_freq__i; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11053_envelope_pr__virus_host_resp_freq__i ON public.epitope_11053_envelope_pr USING btree (taxon_id, host_taxon_id, response_frequency_pos) WITH (fillfactor='100');


--
-- Name: epi_11053_envelope_pr__virus_taxon_and_host_taxon_id__i; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11053_envelope_pr__virus_taxon_and_host_taxon_id__i ON public.epitope_11053_envelope_pr USING btree (taxon_id, host_taxon_id) WITH (fillfactor='100');


--
-- Name: epi_11053_polyprotein__cell_type__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11053_polyprotein__cell_type__idx ON public.epitope_11053_polyprotein USING btree (((cell_type)::text)) WITH (fillfactor='100');


--
-- Name: epi_11053_polyprotein__epi_annotation_start__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11053_polyprotein__epi_annotation_start__idx ON public.epitope_11053_polyprotein USING btree (epi_annotation_start) WITH (fillfactor='100');


--
-- Name: epi_11053_polyprotein__epi_annotation_stop__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11053_polyprotein__epi_annotation_stop__idx ON public.epitope_11053_polyprotein USING btree (epi_annotation_stop) WITH (fillfactor='100');


--
-- Name: epi_11053_polyprotein__epi_frag_annotation_start__i; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11053_polyprotein__epi_frag_annotation_start__i ON public.epitope_11053_polyprotein USING btree (epi_frag_annotation_start) WITH (fillfactor='100');


--
-- Name: epi_11053_polyprotein__epi_frag_annotation_stop__id; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11053_polyprotein__epi_frag_annotation_stop__id ON public.epitope_11053_polyprotein USING btree (epi_frag_annotation_stop) WITH (fillfactor='100');


--
-- Name: epi_11053_polyprotein__host_taxon_id__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11053_polyprotein__host_taxon_id__idx ON public.epitope_11053_polyprotein USING btree (host_taxon_id) WITH (fillfactor='100');


--
-- Name: epi_11053_polyprotein__host_taxon_name_lower__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11053_polyprotein__host_taxon_name_lower__idx ON public.epitope_11053_polyprotein USING btree (lower((host_taxon_name)::text)) WITH (fillfactor='100');


--
-- Name: epi_11053_polyprotein__iedb_epitope_id__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11053_polyprotein__iedb_epitope_id__idx ON public.epitope_11053_polyprotein USING btree (iedb_epitope_id) WITH (fillfactor='100');


--
-- Name: epi_11053_polyprotein__is_linear__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11053_polyprotein__is_linear__idx ON public.epitope_11053_polyprotein USING btree (is_linear) WITH (fillfactor='100');


--
-- Name: epi_11053_polyprotein__mhc_allele__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11053_polyprotein__mhc_allele__idx ON public.epitope_11053_polyprotein USING btree (((mhc_allele)::text)) WITH (fillfactor='100');


--
-- Name: epi_11053_polyprotein__mhc_class_lower__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11053_polyprotein__mhc_class_lower__idx ON public.epitope_11053_polyprotein USING btree (lower((mhc_class)::text)) WITH (fillfactor='100');


--
-- Name: epi_11053_polyprotein__product_lower__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11053_polyprotein__product_lower__idx ON public.epitope_11053_polyprotein USING btree (lower((product)::text)) WITH (fillfactor='100');


--
-- Name: epi_11053_polyprotein__response_frequency_pos__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11053_polyprotein__response_frequency_pos__idx ON public.epitope_11053_polyprotein USING btree (response_frequency_pos) WITH (fillfactor='100');


--
-- Name: epi_11053_polyprotein__sequence_aa_alternative__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11053_polyprotein__sequence_aa_alternative__idx ON public.epitope_11053_polyprotein USING btree (((sequence_aa_alternative)::text)) WITH (fillfactor='100');


--
-- Name: epi_11053_polyprotein__sequence_aa_original__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11053_polyprotein__sequence_aa_original__idx ON public.epitope_11053_polyprotein USING btree (((sequence_aa_original)::text)) WITH (fillfactor='100');


--
-- Name: epi_11053_polyprotein__start_aa_original__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11053_polyprotein__start_aa_original__idx ON public.epitope_11053_polyprotein USING btree (start_aa_original) WITH (fillfactor='100');


--
-- Name: epi_11053_polyprotein__taxon_id__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11053_polyprotein__taxon_id__idx ON public.epitope_11053_polyprotein USING btree (taxon_id) WITH (fillfactor='100');


--
-- Name: epi_11053_polyprotein__taxon_name_lower__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11053_polyprotein__taxon_name_lower__idx ON public.epitope_11053_polyprotein USING btree (lower((taxon_name)::text)) WITH (fillfactor='100');


--
-- Name: epi_11053_polyprotein__variant_aa_length__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11053_polyprotein__variant_aa_length__idx ON public.epitope_11053_polyprotein USING btree (variant_aa_length) WITH (fillfactor='100');


--
-- Name: epi_11053_polyprotein__variant_aa_type__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11053_polyprotein__variant_aa_type__idx ON public.epitope_11053_polyprotein USING btree (((variant_aa_type)::text)) WITH (fillfactor='100');


--
-- Name: epi_11053_polyprotein__virus_host_cell_type__i; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11053_polyprotein__virus_host_cell_type__i ON public.epitope_11053_polyprotein USING btree (taxon_id, host_taxon_id, cell_type) WITH (fillfactor='100');


--
-- Name: epi_11053_polyprotein__virus_host_epi_start__i; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11053_polyprotein__virus_host_epi_start__i ON public.epitope_11053_polyprotein USING btree (taxon_id, host_taxon_id, epi_annotation_start) WITH (fillfactor='100');


--
-- Name: epi_11053_polyprotein__virus_host_epi_stop__i; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11053_polyprotein__virus_host_epi_stop__i ON public.epitope_11053_polyprotein USING btree (taxon_id, host_taxon_id, epi_annotation_stop) WITH (fillfactor='100');


--
-- Name: epi_11053_polyprotein__virus_host_is_linear__i; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11053_polyprotein__virus_host_is_linear__i ON public.epitope_11053_polyprotein USING btree (taxon_id, host_taxon_id, is_linear) WITH (fillfactor='100');


--
-- Name: epi_11053_polyprotein__virus_host_mhc_allele__i; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11053_polyprotein__virus_host_mhc_allele__i ON public.epitope_11053_polyprotein USING btree (taxon_id, host_taxon_id, mhc_allele) WITH (fillfactor='100');


--
-- Name: epi_11053_polyprotein__virus_host_product__i; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11053_polyprotein__virus_host_product__i ON public.epitope_11053_polyprotein USING btree (taxon_id, host_taxon_id, product) WITH (fillfactor='100');


--
-- Name: epi_11053_polyprotein__virus_host_resp_freq__i; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11053_polyprotein__virus_host_resp_freq__i ON public.epitope_11053_polyprotein USING btree (taxon_id, host_taxon_id, response_frequency_pos) WITH (fillfactor='100');


--
-- Name: epi_11053_polyprotein__virus_taxon_and_host_taxon_id__i; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11053_polyprotein__virus_taxon_and_host_taxon_id__i ON public.epitope_11053_polyprotein USING btree (taxon_id, host_taxon_id) WITH (fillfactor='100');


--
-- Name: epi_11060_envelope_pr__cell_type__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11060_envelope_pr__cell_type__idx ON public.epitope_11060_envelope_pr USING btree (((cell_type)::text)) WITH (fillfactor='100');


--
-- Name: epi_11060_envelope_pr__epi_annotation_start__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11060_envelope_pr__epi_annotation_start__idx ON public.epitope_11060_envelope_pr USING btree (epi_annotation_start) WITH (fillfactor='100');


--
-- Name: epi_11060_envelope_pr__epi_annotation_stop__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11060_envelope_pr__epi_annotation_stop__idx ON public.epitope_11060_envelope_pr USING btree (epi_annotation_stop) WITH (fillfactor='100');


--
-- Name: epi_11060_envelope_pr__epi_frag_annotation_start__i; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11060_envelope_pr__epi_frag_annotation_start__i ON public.epitope_11060_envelope_pr USING btree (epi_frag_annotation_start) WITH (fillfactor='100');


--
-- Name: epi_11060_envelope_pr__epi_frag_annotation_stop__id; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11060_envelope_pr__epi_frag_annotation_stop__id ON public.epitope_11060_envelope_pr USING btree (epi_frag_annotation_stop) WITH (fillfactor='100');


--
-- Name: epi_11060_envelope_pr__host_taxon_id__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11060_envelope_pr__host_taxon_id__idx ON public.epitope_11060_envelope_pr USING btree (host_taxon_id) WITH (fillfactor='100');


--
-- Name: epi_11060_envelope_pr__host_taxon_name_lower__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11060_envelope_pr__host_taxon_name_lower__idx ON public.epitope_11060_envelope_pr USING btree (lower((host_taxon_name)::text)) WITH (fillfactor='100');


--
-- Name: epi_11060_envelope_pr__iedb_epitope_id__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11060_envelope_pr__iedb_epitope_id__idx ON public.epitope_11060_envelope_pr USING btree (iedb_epitope_id) WITH (fillfactor='100');


--
-- Name: epi_11060_envelope_pr__is_linear__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11060_envelope_pr__is_linear__idx ON public.epitope_11060_envelope_pr USING btree (is_linear) WITH (fillfactor='100');


--
-- Name: epi_11060_envelope_pr__mhc_allele__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11060_envelope_pr__mhc_allele__idx ON public.epitope_11060_envelope_pr USING btree (((mhc_allele)::text)) WITH (fillfactor='100');


--
-- Name: epi_11060_envelope_pr__mhc_class_lower__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11060_envelope_pr__mhc_class_lower__idx ON public.epitope_11060_envelope_pr USING btree (lower((mhc_class)::text)) WITH (fillfactor='100');


--
-- Name: epi_11060_envelope_pr__product_lower__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11060_envelope_pr__product_lower__idx ON public.epitope_11060_envelope_pr USING btree (lower((product)::text)) WITH (fillfactor='100');


--
-- Name: epi_11060_envelope_pr__response_frequency_pos__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11060_envelope_pr__response_frequency_pos__idx ON public.epitope_11060_envelope_pr USING btree (response_frequency_pos) WITH (fillfactor='100');


--
-- Name: epi_11060_envelope_pr__sequence_aa_alternative__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11060_envelope_pr__sequence_aa_alternative__idx ON public.epitope_11060_envelope_pr USING btree (((sequence_aa_alternative)::text)) WITH (fillfactor='100');


--
-- Name: epi_11060_envelope_pr__sequence_aa_original__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11060_envelope_pr__sequence_aa_original__idx ON public.epitope_11060_envelope_pr USING btree (((sequence_aa_original)::text)) WITH (fillfactor='100');


--
-- Name: epi_11060_envelope_pr__start_aa_original__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11060_envelope_pr__start_aa_original__idx ON public.epitope_11060_envelope_pr USING btree (start_aa_original) WITH (fillfactor='100');


--
-- Name: epi_11060_envelope_pr__taxon_id__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11060_envelope_pr__taxon_id__idx ON public.epitope_11060_envelope_pr USING btree (taxon_id) WITH (fillfactor='100');


--
-- Name: epi_11060_envelope_pr__taxon_name_lower__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11060_envelope_pr__taxon_name_lower__idx ON public.epitope_11060_envelope_pr USING btree (lower((taxon_name)::text)) WITH (fillfactor='100');


--
-- Name: epi_11060_envelope_pr__variant_aa_length__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11060_envelope_pr__variant_aa_length__idx ON public.epitope_11060_envelope_pr USING btree (variant_aa_length) WITH (fillfactor='100');


--
-- Name: epi_11060_envelope_pr__variant_aa_type__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11060_envelope_pr__variant_aa_type__idx ON public.epitope_11060_envelope_pr USING btree (((variant_aa_type)::text)) WITH (fillfactor='100');


--
-- Name: epi_11060_envelope_pr__virus_host_cell_type__i; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11060_envelope_pr__virus_host_cell_type__i ON public.epitope_11060_envelope_pr USING btree (taxon_id, host_taxon_id, cell_type) WITH (fillfactor='100');


--
-- Name: epi_11060_envelope_pr__virus_host_epi_start__i; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11060_envelope_pr__virus_host_epi_start__i ON public.epitope_11060_envelope_pr USING btree (taxon_id, host_taxon_id, epi_annotation_start) WITH (fillfactor='100');


--
-- Name: epi_11060_envelope_pr__virus_host_epi_stop__i; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11060_envelope_pr__virus_host_epi_stop__i ON public.epitope_11060_envelope_pr USING btree (taxon_id, host_taxon_id, epi_annotation_stop) WITH (fillfactor='100');


--
-- Name: epi_11060_envelope_pr__virus_host_is_linear__i; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11060_envelope_pr__virus_host_is_linear__i ON public.epitope_11060_envelope_pr USING btree (taxon_id, host_taxon_id, is_linear) WITH (fillfactor='100');


--
-- Name: epi_11060_envelope_pr__virus_host_mhc_allele__i; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11060_envelope_pr__virus_host_mhc_allele__i ON public.epitope_11060_envelope_pr USING btree (taxon_id, host_taxon_id, mhc_allele) WITH (fillfactor='100');


--
-- Name: epi_11060_envelope_pr__virus_host_product__i; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11060_envelope_pr__virus_host_product__i ON public.epitope_11060_envelope_pr USING btree (taxon_id, host_taxon_id, product) WITH (fillfactor='100');


--
-- Name: epi_11060_envelope_pr__virus_host_resp_freq__i; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11060_envelope_pr__virus_host_resp_freq__i ON public.epitope_11060_envelope_pr USING btree (taxon_id, host_taxon_id, response_frequency_pos) WITH (fillfactor='100');


--
-- Name: epi_11060_envelope_pr__virus_taxon_and_host_taxon_id__i; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11060_envelope_pr__virus_taxon_and_host_taxon_id__i ON public.epitope_11060_envelope_pr USING btree (taxon_id, host_taxon_id) WITH (fillfactor='100');


--
-- Name: epi_11060_polyprotein__cell_type__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11060_polyprotein__cell_type__idx ON public.epitope_11060_polyprotein USING btree (((cell_type)::text)) WITH (fillfactor='100');


--
-- Name: epi_11060_polyprotein__epi_annotation_start__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11060_polyprotein__epi_annotation_start__idx ON public.epitope_11060_polyprotein USING btree (epi_annotation_start) WITH (fillfactor='100');


--
-- Name: epi_11060_polyprotein__epi_annotation_stop__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11060_polyprotein__epi_annotation_stop__idx ON public.epitope_11060_polyprotein USING btree (epi_annotation_stop) WITH (fillfactor='100');


--
-- Name: epi_11060_polyprotein__epi_frag_annotation_start__i; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11060_polyprotein__epi_frag_annotation_start__i ON public.epitope_11060_polyprotein USING btree (epi_frag_annotation_start) WITH (fillfactor='100');


--
-- Name: epi_11060_polyprotein__epi_frag_annotation_stop__id; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11060_polyprotein__epi_frag_annotation_stop__id ON public.epitope_11060_polyprotein USING btree (epi_frag_annotation_stop) WITH (fillfactor='100');


--
-- Name: epi_11060_polyprotein__host_taxon_id__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11060_polyprotein__host_taxon_id__idx ON public.epitope_11060_polyprotein USING btree (host_taxon_id) WITH (fillfactor='100');


--
-- Name: epi_11060_polyprotein__host_taxon_name_lower__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11060_polyprotein__host_taxon_name_lower__idx ON public.epitope_11060_polyprotein USING btree (lower((host_taxon_name)::text)) WITH (fillfactor='100');


--
-- Name: epi_11060_polyprotein__iedb_epitope_id__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11060_polyprotein__iedb_epitope_id__idx ON public.epitope_11060_polyprotein USING btree (iedb_epitope_id) WITH (fillfactor='100');


--
-- Name: epi_11060_polyprotein__is_linear__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11060_polyprotein__is_linear__idx ON public.epitope_11060_polyprotein USING btree (is_linear) WITH (fillfactor='100');


--
-- Name: epi_11060_polyprotein__mhc_allele__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11060_polyprotein__mhc_allele__idx ON public.epitope_11060_polyprotein USING btree (((mhc_allele)::text)) WITH (fillfactor='100');


--
-- Name: epi_11060_polyprotein__mhc_class_lower__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11060_polyprotein__mhc_class_lower__idx ON public.epitope_11060_polyprotein USING btree (lower((mhc_class)::text)) WITH (fillfactor='100');


--
-- Name: epi_11060_polyprotein__product_lower__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11060_polyprotein__product_lower__idx ON public.epitope_11060_polyprotein USING btree (lower((product)::text)) WITH (fillfactor='100');


--
-- Name: epi_11060_polyprotein__response_frequency_pos__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11060_polyprotein__response_frequency_pos__idx ON public.epitope_11060_polyprotein USING btree (response_frequency_pos) WITH (fillfactor='100');


--
-- Name: epi_11060_polyprotein__sequence_aa_alternative__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11060_polyprotein__sequence_aa_alternative__idx ON public.epitope_11060_polyprotein USING btree (((sequence_aa_alternative)::text)) WITH (fillfactor='100');


--
-- Name: epi_11060_polyprotein__sequence_aa_original__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11060_polyprotein__sequence_aa_original__idx ON public.epitope_11060_polyprotein USING btree (((sequence_aa_original)::text)) WITH (fillfactor='100');


--
-- Name: epi_11060_polyprotein__start_aa_original__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11060_polyprotein__start_aa_original__idx ON public.epitope_11060_polyprotein USING btree (start_aa_original) WITH (fillfactor='100');


--
-- Name: epi_11060_polyprotein__taxon_id__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11060_polyprotein__taxon_id__idx ON public.epitope_11060_polyprotein USING btree (taxon_id) WITH (fillfactor='100');


--
-- Name: epi_11060_polyprotein__taxon_name_lower__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11060_polyprotein__taxon_name_lower__idx ON public.epitope_11060_polyprotein USING btree (lower((taxon_name)::text)) WITH (fillfactor='100');


--
-- Name: epi_11060_polyprotein__variant_aa_length__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11060_polyprotein__variant_aa_length__idx ON public.epitope_11060_polyprotein USING btree (variant_aa_length) WITH (fillfactor='100');


--
-- Name: epi_11060_polyprotein__variant_aa_type__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11060_polyprotein__variant_aa_type__idx ON public.epitope_11060_polyprotein USING btree (((variant_aa_type)::text)) WITH (fillfactor='100');


--
-- Name: epi_11060_polyprotein__virus_host_cell_type__i; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11060_polyprotein__virus_host_cell_type__i ON public.epitope_11060_polyprotein USING btree (taxon_id, host_taxon_id, cell_type) WITH (fillfactor='100');


--
-- Name: epi_11060_polyprotein__virus_host_epi_start__i; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11060_polyprotein__virus_host_epi_start__i ON public.epitope_11060_polyprotein USING btree (taxon_id, host_taxon_id, epi_annotation_start) WITH (fillfactor='100');


--
-- Name: epi_11060_polyprotein__virus_host_epi_stop__i; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11060_polyprotein__virus_host_epi_stop__i ON public.epitope_11060_polyprotein USING btree (taxon_id, host_taxon_id, epi_annotation_stop) WITH (fillfactor='100');


--
-- Name: epi_11060_polyprotein__virus_host_is_linear__i; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11060_polyprotein__virus_host_is_linear__i ON public.epitope_11060_polyprotein USING btree (taxon_id, host_taxon_id, is_linear) WITH (fillfactor='100');


--
-- Name: epi_11060_polyprotein__virus_host_mhc_allele__i; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11060_polyprotein__virus_host_mhc_allele__i ON public.epitope_11060_polyprotein USING btree (taxon_id, host_taxon_id, mhc_allele) WITH (fillfactor='100');


--
-- Name: epi_11060_polyprotein__virus_host_product__i; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11060_polyprotein__virus_host_product__i ON public.epitope_11060_polyprotein USING btree (taxon_id, host_taxon_id, product) WITH (fillfactor='100');


--
-- Name: epi_11060_polyprotein__virus_host_resp_freq__i; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11060_polyprotein__virus_host_resp_freq__i ON public.epitope_11060_polyprotein USING btree (taxon_id, host_taxon_id, response_frequency_pos) WITH (fillfactor='100');


--
-- Name: epi_11060_polyprotein__virus_taxon_and_host_taxon_id__i; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11060_polyprotein__virus_taxon_and_host_taxon_id__i ON public.epitope_11060_polyprotein USING btree (taxon_id, host_taxon_id) WITH (fillfactor='100');


--
-- Name: epi_11069_envelope_pr__cell_type__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11069_envelope_pr__cell_type__idx ON public.epitope_11069_envelope_pr USING btree (((cell_type)::text)) WITH (fillfactor='100');


--
-- Name: epi_11069_envelope_pr__epi_annotation_start__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11069_envelope_pr__epi_annotation_start__idx ON public.epitope_11069_envelope_pr USING btree (epi_annotation_start) WITH (fillfactor='100');


--
-- Name: epi_11069_envelope_pr__epi_annotation_stop__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11069_envelope_pr__epi_annotation_stop__idx ON public.epitope_11069_envelope_pr USING btree (epi_annotation_stop) WITH (fillfactor='100');


--
-- Name: epi_11069_envelope_pr__epi_frag_annotation_start__i; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11069_envelope_pr__epi_frag_annotation_start__i ON public.epitope_11069_envelope_pr USING btree (epi_frag_annotation_start) WITH (fillfactor='100');


--
-- Name: epi_11069_envelope_pr__epi_frag_annotation_stop__id; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11069_envelope_pr__epi_frag_annotation_stop__id ON public.epitope_11069_envelope_pr USING btree (epi_frag_annotation_stop) WITH (fillfactor='100');


--
-- Name: epi_11069_envelope_pr__host_taxon_id__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11069_envelope_pr__host_taxon_id__idx ON public.epitope_11069_envelope_pr USING btree (host_taxon_id) WITH (fillfactor='100');


--
-- Name: epi_11069_envelope_pr__host_taxon_name_lower__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11069_envelope_pr__host_taxon_name_lower__idx ON public.epitope_11069_envelope_pr USING btree (lower((host_taxon_name)::text)) WITH (fillfactor='100');


--
-- Name: epi_11069_envelope_pr__iedb_epitope_id__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11069_envelope_pr__iedb_epitope_id__idx ON public.epitope_11069_envelope_pr USING btree (iedb_epitope_id) WITH (fillfactor='100');


--
-- Name: epi_11069_envelope_pr__is_linear__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11069_envelope_pr__is_linear__idx ON public.epitope_11069_envelope_pr USING btree (is_linear) WITH (fillfactor='100');


--
-- Name: epi_11069_envelope_pr__mhc_allele__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11069_envelope_pr__mhc_allele__idx ON public.epitope_11069_envelope_pr USING btree (((mhc_allele)::text)) WITH (fillfactor='100');


--
-- Name: epi_11069_envelope_pr__mhc_class_lower__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11069_envelope_pr__mhc_class_lower__idx ON public.epitope_11069_envelope_pr USING btree (lower((mhc_class)::text)) WITH (fillfactor='100');


--
-- Name: epi_11069_envelope_pr__product_lower__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11069_envelope_pr__product_lower__idx ON public.epitope_11069_envelope_pr USING btree (lower((product)::text)) WITH (fillfactor='100');


--
-- Name: epi_11069_envelope_pr__response_frequency_pos__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11069_envelope_pr__response_frequency_pos__idx ON public.epitope_11069_envelope_pr USING btree (response_frequency_pos) WITH (fillfactor='100');


--
-- Name: epi_11069_envelope_pr__sequence_aa_alternative__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11069_envelope_pr__sequence_aa_alternative__idx ON public.epitope_11069_envelope_pr USING btree (((sequence_aa_alternative)::text)) WITH (fillfactor='100');


--
-- Name: epi_11069_envelope_pr__sequence_aa_original__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11069_envelope_pr__sequence_aa_original__idx ON public.epitope_11069_envelope_pr USING btree (((sequence_aa_original)::text)) WITH (fillfactor='100');


--
-- Name: epi_11069_envelope_pr__start_aa_original__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11069_envelope_pr__start_aa_original__idx ON public.epitope_11069_envelope_pr USING btree (start_aa_original) WITH (fillfactor='100');


--
-- Name: epi_11069_envelope_pr__taxon_id__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11069_envelope_pr__taxon_id__idx ON public.epitope_11069_envelope_pr USING btree (taxon_id) WITH (fillfactor='100');


--
-- Name: epi_11069_envelope_pr__taxon_name_lower__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11069_envelope_pr__taxon_name_lower__idx ON public.epitope_11069_envelope_pr USING btree (lower((taxon_name)::text)) WITH (fillfactor='100');


--
-- Name: epi_11069_envelope_pr__variant_aa_length__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11069_envelope_pr__variant_aa_length__idx ON public.epitope_11069_envelope_pr USING btree (variant_aa_length) WITH (fillfactor='100');


--
-- Name: epi_11069_envelope_pr__variant_aa_type__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11069_envelope_pr__variant_aa_type__idx ON public.epitope_11069_envelope_pr USING btree (((variant_aa_type)::text)) WITH (fillfactor='100');


--
-- Name: epi_11069_envelope_pr__virus_host_cell_type__i; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11069_envelope_pr__virus_host_cell_type__i ON public.epitope_11069_envelope_pr USING btree (taxon_id, host_taxon_id, cell_type) WITH (fillfactor='100');


--
-- Name: epi_11069_envelope_pr__virus_host_epi_start__i; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11069_envelope_pr__virus_host_epi_start__i ON public.epitope_11069_envelope_pr USING btree (taxon_id, host_taxon_id, epi_annotation_start) WITH (fillfactor='100');


--
-- Name: epi_11069_envelope_pr__virus_host_epi_stop__i; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11069_envelope_pr__virus_host_epi_stop__i ON public.epitope_11069_envelope_pr USING btree (taxon_id, host_taxon_id, epi_annotation_stop) WITH (fillfactor='100');


--
-- Name: epi_11069_envelope_pr__virus_host_is_linear__i; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11069_envelope_pr__virus_host_is_linear__i ON public.epitope_11069_envelope_pr USING btree (taxon_id, host_taxon_id, is_linear) WITH (fillfactor='100');


--
-- Name: epi_11069_envelope_pr__virus_host_mhc_allele__i; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11069_envelope_pr__virus_host_mhc_allele__i ON public.epitope_11069_envelope_pr USING btree (taxon_id, host_taxon_id, mhc_allele) WITH (fillfactor='100');


--
-- Name: epi_11069_envelope_pr__virus_host_product__i; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11069_envelope_pr__virus_host_product__i ON public.epitope_11069_envelope_pr USING btree (taxon_id, host_taxon_id, product) WITH (fillfactor='100');


--
-- Name: epi_11069_envelope_pr__virus_host_resp_freq__i; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11069_envelope_pr__virus_host_resp_freq__i ON public.epitope_11069_envelope_pr USING btree (taxon_id, host_taxon_id, response_frequency_pos) WITH (fillfactor='100');


--
-- Name: epi_11069_envelope_pr__virus_taxon_and_host_taxon_id__i; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11069_envelope_pr__virus_taxon_and_host_taxon_id__i ON public.epitope_11069_envelope_pr USING btree (taxon_id, host_taxon_id) WITH (fillfactor='100');


--
-- Name: epi_11069_polyprotein__cell_type__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11069_polyprotein__cell_type__idx ON public.epitope_11069_polyprotein USING btree (((cell_type)::text)) WITH (fillfactor='100');


--
-- Name: epi_11069_polyprotein__epi_annotation_start__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11069_polyprotein__epi_annotation_start__idx ON public.epitope_11069_polyprotein USING btree (epi_annotation_start) WITH (fillfactor='100');


--
-- Name: epi_11069_polyprotein__epi_annotation_stop__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11069_polyprotein__epi_annotation_stop__idx ON public.epitope_11069_polyprotein USING btree (epi_annotation_stop) WITH (fillfactor='100');


--
-- Name: epi_11069_polyprotein__epi_frag_annotation_start__i; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11069_polyprotein__epi_frag_annotation_start__i ON public.epitope_11069_polyprotein USING btree (epi_frag_annotation_start) WITH (fillfactor='100');


--
-- Name: epi_11069_polyprotein__epi_frag_annotation_stop__id; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11069_polyprotein__epi_frag_annotation_stop__id ON public.epitope_11069_polyprotein USING btree (epi_frag_annotation_stop) WITH (fillfactor='100');


--
-- Name: epi_11069_polyprotein__host_taxon_id__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11069_polyprotein__host_taxon_id__idx ON public.epitope_11069_polyprotein USING btree (host_taxon_id) WITH (fillfactor='100');


--
-- Name: epi_11069_polyprotein__host_taxon_name_lower__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11069_polyprotein__host_taxon_name_lower__idx ON public.epitope_11069_polyprotein USING btree (lower((host_taxon_name)::text)) WITH (fillfactor='100');


--
-- Name: epi_11069_polyprotein__iedb_epitope_id__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11069_polyprotein__iedb_epitope_id__idx ON public.epitope_11069_polyprotein USING btree (iedb_epitope_id) WITH (fillfactor='100');


--
-- Name: epi_11069_polyprotein__is_linear__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11069_polyprotein__is_linear__idx ON public.epitope_11069_polyprotein USING btree (is_linear) WITH (fillfactor='100');


--
-- Name: epi_11069_polyprotein__mhc_allele__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11069_polyprotein__mhc_allele__idx ON public.epitope_11069_polyprotein USING btree (((mhc_allele)::text)) WITH (fillfactor='100');


--
-- Name: epi_11069_polyprotein__mhc_class_lower__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11069_polyprotein__mhc_class_lower__idx ON public.epitope_11069_polyprotein USING btree (lower((mhc_class)::text)) WITH (fillfactor='100');


--
-- Name: epi_11069_polyprotein__product_lower__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11069_polyprotein__product_lower__idx ON public.epitope_11069_polyprotein USING btree (lower((product)::text)) WITH (fillfactor='100');


--
-- Name: epi_11069_polyprotein__response_frequency_pos__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11069_polyprotein__response_frequency_pos__idx ON public.epitope_11069_polyprotein USING btree (response_frequency_pos) WITH (fillfactor='100');


--
-- Name: epi_11069_polyprotein__sequence_aa_alternative__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11069_polyprotein__sequence_aa_alternative__idx ON public.epitope_11069_polyprotein USING btree (((sequence_aa_alternative)::text)) WITH (fillfactor='100');


--
-- Name: epi_11069_polyprotein__sequence_aa_original__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11069_polyprotein__sequence_aa_original__idx ON public.epitope_11069_polyprotein USING btree (((sequence_aa_original)::text)) WITH (fillfactor='100');


--
-- Name: epi_11069_polyprotein__start_aa_original__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11069_polyprotein__start_aa_original__idx ON public.epitope_11069_polyprotein USING btree (start_aa_original) WITH (fillfactor='100');


--
-- Name: epi_11069_polyprotein__taxon_id__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11069_polyprotein__taxon_id__idx ON public.epitope_11069_polyprotein USING btree (taxon_id) WITH (fillfactor='100');


--
-- Name: epi_11069_polyprotein__taxon_name_lower__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11069_polyprotein__taxon_name_lower__idx ON public.epitope_11069_polyprotein USING btree (lower((taxon_name)::text)) WITH (fillfactor='100');


--
-- Name: epi_11069_polyprotein__variant_aa_length__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11069_polyprotein__variant_aa_length__idx ON public.epitope_11069_polyprotein USING btree (variant_aa_length) WITH (fillfactor='100');


--
-- Name: epi_11069_polyprotein__variant_aa_type__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11069_polyprotein__variant_aa_type__idx ON public.epitope_11069_polyprotein USING btree (((variant_aa_type)::text)) WITH (fillfactor='100');


--
-- Name: epi_11069_polyprotein__virus_host_cell_type__i; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11069_polyprotein__virus_host_cell_type__i ON public.epitope_11069_polyprotein USING btree (taxon_id, host_taxon_id, cell_type) WITH (fillfactor='100');


--
-- Name: epi_11069_polyprotein__virus_host_epi_start__i; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11069_polyprotein__virus_host_epi_start__i ON public.epitope_11069_polyprotein USING btree (taxon_id, host_taxon_id, epi_annotation_start) WITH (fillfactor='100');


--
-- Name: epi_11069_polyprotein__virus_host_epi_stop__i; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11069_polyprotein__virus_host_epi_stop__i ON public.epitope_11069_polyprotein USING btree (taxon_id, host_taxon_id, epi_annotation_stop) WITH (fillfactor='100');


--
-- Name: epi_11069_polyprotein__virus_host_is_linear__i; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11069_polyprotein__virus_host_is_linear__i ON public.epitope_11069_polyprotein USING btree (taxon_id, host_taxon_id, is_linear) WITH (fillfactor='100');


--
-- Name: epi_11069_polyprotein__virus_host_mhc_allele__i; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11069_polyprotein__virus_host_mhc_allele__i ON public.epitope_11069_polyprotein USING btree (taxon_id, host_taxon_id, mhc_allele) WITH (fillfactor='100');


--
-- Name: epi_11069_polyprotein__virus_host_product__i; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11069_polyprotein__virus_host_product__i ON public.epitope_11069_polyprotein USING btree (taxon_id, host_taxon_id, product) WITH (fillfactor='100');


--
-- Name: epi_11069_polyprotein__virus_host_resp_freq__i; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11069_polyprotein__virus_host_resp_freq__i ON public.epitope_11069_polyprotein USING btree (taxon_id, host_taxon_id, response_frequency_pos) WITH (fillfactor='100');


--
-- Name: epi_11069_polyprotein__virus_taxon_and_host_taxon_id__i; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11069_polyprotein__virus_taxon_and_host_taxon_id__i ON public.epitope_11069_polyprotein USING btree (taxon_id, host_taxon_id) WITH (fillfactor='100');


--
-- Name: epi_11070_envelope_pr__cell_type__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11070_envelope_pr__cell_type__idx ON public.epitope_11070_envelope_pr USING btree (((cell_type)::text)) WITH (fillfactor='100');


--
-- Name: epi_11070_envelope_pr__epi_annotation_start__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11070_envelope_pr__epi_annotation_start__idx ON public.epitope_11070_envelope_pr USING btree (epi_annotation_start) WITH (fillfactor='100');


--
-- Name: epi_11070_envelope_pr__epi_annotation_stop__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11070_envelope_pr__epi_annotation_stop__idx ON public.epitope_11070_envelope_pr USING btree (epi_annotation_stop) WITH (fillfactor='100');


--
-- Name: epi_11070_envelope_pr__epi_frag_annotation_start__i; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11070_envelope_pr__epi_frag_annotation_start__i ON public.epitope_11070_envelope_pr USING btree (epi_frag_annotation_start) WITH (fillfactor='100');


--
-- Name: epi_11070_envelope_pr__epi_frag_annotation_stop__id; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11070_envelope_pr__epi_frag_annotation_stop__id ON public.epitope_11070_envelope_pr USING btree (epi_frag_annotation_stop) WITH (fillfactor='100');


--
-- Name: epi_11070_envelope_pr__host_taxon_id__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11070_envelope_pr__host_taxon_id__idx ON public.epitope_11070_envelope_pr USING btree (host_taxon_id) WITH (fillfactor='100');


--
-- Name: epi_11070_envelope_pr__host_taxon_name_lower__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11070_envelope_pr__host_taxon_name_lower__idx ON public.epitope_11070_envelope_pr USING btree (lower((host_taxon_name)::text)) WITH (fillfactor='100');


--
-- Name: epi_11070_envelope_pr__iedb_epitope_id__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11070_envelope_pr__iedb_epitope_id__idx ON public.epitope_11070_envelope_pr USING btree (iedb_epitope_id) WITH (fillfactor='100');


--
-- Name: epi_11070_envelope_pr__is_linear__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11070_envelope_pr__is_linear__idx ON public.epitope_11070_envelope_pr USING btree (is_linear) WITH (fillfactor='100');


--
-- Name: epi_11070_envelope_pr__mhc_allele__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11070_envelope_pr__mhc_allele__idx ON public.epitope_11070_envelope_pr USING btree (((mhc_allele)::text)) WITH (fillfactor='100');


--
-- Name: epi_11070_envelope_pr__mhc_class_lower__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11070_envelope_pr__mhc_class_lower__idx ON public.epitope_11070_envelope_pr USING btree (lower((mhc_class)::text)) WITH (fillfactor='100');


--
-- Name: epi_11070_envelope_pr__product_lower__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11070_envelope_pr__product_lower__idx ON public.epitope_11070_envelope_pr USING btree (lower((product)::text)) WITH (fillfactor='100');


--
-- Name: epi_11070_envelope_pr__response_frequency_pos__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11070_envelope_pr__response_frequency_pos__idx ON public.epitope_11070_envelope_pr USING btree (response_frequency_pos) WITH (fillfactor='100');


--
-- Name: epi_11070_envelope_pr__sequence_aa_alternative__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11070_envelope_pr__sequence_aa_alternative__idx ON public.epitope_11070_envelope_pr USING btree (((sequence_aa_alternative)::text)) WITH (fillfactor='100');


--
-- Name: epi_11070_envelope_pr__sequence_aa_original__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11070_envelope_pr__sequence_aa_original__idx ON public.epitope_11070_envelope_pr USING btree (((sequence_aa_original)::text)) WITH (fillfactor='100');


--
-- Name: epi_11070_envelope_pr__start_aa_original__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11070_envelope_pr__start_aa_original__idx ON public.epitope_11070_envelope_pr USING btree (start_aa_original) WITH (fillfactor='100');


--
-- Name: epi_11070_envelope_pr__taxon_id__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11070_envelope_pr__taxon_id__idx ON public.epitope_11070_envelope_pr USING btree (taxon_id) WITH (fillfactor='100');


--
-- Name: epi_11070_envelope_pr__taxon_name_lower__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11070_envelope_pr__taxon_name_lower__idx ON public.epitope_11070_envelope_pr USING btree (lower((taxon_name)::text)) WITH (fillfactor='100');


--
-- Name: epi_11070_envelope_pr__variant_aa_length__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11070_envelope_pr__variant_aa_length__idx ON public.epitope_11070_envelope_pr USING btree (variant_aa_length) WITH (fillfactor='100');


--
-- Name: epi_11070_envelope_pr__variant_aa_type__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11070_envelope_pr__variant_aa_type__idx ON public.epitope_11070_envelope_pr USING btree (((variant_aa_type)::text)) WITH (fillfactor='100');


--
-- Name: epi_11070_envelope_pr__virus_host_cell_type__i; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11070_envelope_pr__virus_host_cell_type__i ON public.epitope_11070_envelope_pr USING btree (taxon_id, host_taxon_id, cell_type) WITH (fillfactor='100');


--
-- Name: epi_11070_envelope_pr__virus_host_epi_start__i; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11070_envelope_pr__virus_host_epi_start__i ON public.epitope_11070_envelope_pr USING btree (taxon_id, host_taxon_id, epi_annotation_start) WITH (fillfactor='100');


--
-- Name: epi_11070_envelope_pr__virus_host_epi_stop__i; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11070_envelope_pr__virus_host_epi_stop__i ON public.epitope_11070_envelope_pr USING btree (taxon_id, host_taxon_id, epi_annotation_stop) WITH (fillfactor='100');


--
-- Name: epi_11070_envelope_pr__virus_host_is_linear__i; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11070_envelope_pr__virus_host_is_linear__i ON public.epitope_11070_envelope_pr USING btree (taxon_id, host_taxon_id, is_linear) WITH (fillfactor='100');


--
-- Name: epi_11070_envelope_pr__virus_host_mhc_allele__i; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11070_envelope_pr__virus_host_mhc_allele__i ON public.epitope_11070_envelope_pr USING btree (taxon_id, host_taxon_id, mhc_allele) WITH (fillfactor='100');


--
-- Name: epi_11070_envelope_pr__virus_host_product__i; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11070_envelope_pr__virus_host_product__i ON public.epitope_11070_envelope_pr USING btree (taxon_id, host_taxon_id, product) WITH (fillfactor='100');


--
-- Name: epi_11070_envelope_pr__virus_host_resp_freq__i; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11070_envelope_pr__virus_host_resp_freq__i ON public.epitope_11070_envelope_pr USING btree (taxon_id, host_taxon_id, response_frequency_pos) WITH (fillfactor='100');


--
-- Name: epi_11070_envelope_pr__virus_taxon_and_host_taxon_id__i; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11070_envelope_pr__virus_taxon_and_host_taxon_id__i ON public.epitope_11070_envelope_pr USING btree (taxon_id, host_taxon_id) WITH (fillfactor='100');


--
-- Name: epi_11070_polyprotein__cell_type__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11070_polyprotein__cell_type__idx ON public.epitope_11070_polyprotein USING btree (((cell_type)::text)) WITH (fillfactor='100');


--
-- Name: epi_11070_polyprotein__epi_annotation_start__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11070_polyprotein__epi_annotation_start__idx ON public.epitope_11070_polyprotein USING btree (epi_annotation_start) WITH (fillfactor='100');


--
-- Name: epi_11070_polyprotein__epi_annotation_stop__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11070_polyprotein__epi_annotation_stop__idx ON public.epitope_11070_polyprotein USING btree (epi_annotation_stop) WITH (fillfactor='100');


--
-- Name: epi_11070_polyprotein__epi_frag_annotation_start__i; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11070_polyprotein__epi_frag_annotation_start__i ON public.epitope_11070_polyprotein USING btree (epi_frag_annotation_start) WITH (fillfactor='100');


--
-- Name: epi_11070_polyprotein__epi_frag_annotation_stop__id; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11070_polyprotein__epi_frag_annotation_stop__id ON public.epitope_11070_polyprotein USING btree (epi_frag_annotation_stop) WITH (fillfactor='100');


--
-- Name: epi_11070_polyprotein__host_taxon_id__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11070_polyprotein__host_taxon_id__idx ON public.epitope_11070_polyprotein USING btree (host_taxon_id) WITH (fillfactor='100');


--
-- Name: epi_11070_polyprotein__host_taxon_name_lower__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11070_polyprotein__host_taxon_name_lower__idx ON public.epitope_11070_polyprotein USING btree (lower((host_taxon_name)::text)) WITH (fillfactor='100');


--
-- Name: epi_11070_polyprotein__iedb_epitope_id__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11070_polyprotein__iedb_epitope_id__idx ON public.epitope_11070_polyprotein USING btree (iedb_epitope_id) WITH (fillfactor='100');


--
-- Name: epi_11070_polyprotein__is_linear__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11070_polyprotein__is_linear__idx ON public.epitope_11070_polyprotein USING btree (is_linear) WITH (fillfactor='100');


--
-- Name: epi_11070_polyprotein__mhc_allele__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11070_polyprotein__mhc_allele__idx ON public.epitope_11070_polyprotein USING btree (((mhc_allele)::text)) WITH (fillfactor='100');


--
-- Name: epi_11070_polyprotein__mhc_class_lower__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11070_polyprotein__mhc_class_lower__idx ON public.epitope_11070_polyprotein USING btree (lower((mhc_class)::text)) WITH (fillfactor='100');


--
-- Name: epi_11070_polyprotein__product_lower__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11070_polyprotein__product_lower__idx ON public.epitope_11070_polyprotein USING btree (lower((product)::text)) WITH (fillfactor='100');


--
-- Name: epi_11070_polyprotein__response_frequency_pos__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11070_polyprotein__response_frequency_pos__idx ON public.epitope_11070_polyprotein USING btree (response_frequency_pos) WITH (fillfactor='100');


--
-- Name: epi_11070_polyprotein__sequence_aa_alternative__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11070_polyprotein__sequence_aa_alternative__idx ON public.epitope_11070_polyprotein USING btree (((sequence_aa_alternative)::text)) WITH (fillfactor='100');


--
-- Name: epi_11070_polyprotein__sequence_aa_original__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11070_polyprotein__sequence_aa_original__idx ON public.epitope_11070_polyprotein USING btree (((sequence_aa_original)::text)) WITH (fillfactor='100');


--
-- Name: epi_11070_polyprotein__start_aa_original__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11070_polyprotein__start_aa_original__idx ON public.epitope_11070_polyprotein USING btree (start_aa_original) WITH (fillfactor='100');


--
-- Name: epi_11070_polyprotein__taxon_id__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11070_polyprotein__taxon_id__idx ON public.epitope_11070_polyprotein USING btree (taxon_id) WITH (fillfactor='100');


--
-- Name: epi_11070_polyprotein__taxon_name_lower__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11070_polyprotein__taxon_name_lower__idx ON public.epitope_11070_polyprotein USING btree (lower((taxon_name)::text)) WITH (fillfactor='100');


--
-- Name: epi_11070_polyprotein__variant_aa_length__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11070_polyprotein__variant_aa_length__idx ON public.epitope_11070_polyprotein USING btree (variant_aa_length) WITH (fillfactor='100');


--
-- Name: epi_11070_polyprotein__variant_aa_type__idx; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11070_polyprotein__variant_aa_type__idx ON public.epitope_11070_polyprotein USING btree (((variant_aa_type)::text)) WITH (fillfactor='100');


--
-- Name: epi_11070_polyprotein__virus_host_cell_type__i; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11070_polyprotein__virus_host_cell_type__i ON public.epitope_11070_polyprotein USING btree (taxon_id, host_taxon_id, cell_type) WITH (fillfactor='100');


--
-- Name: epi_11070_polyprotein__virus_host_epi_start__i; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11070_polyprotein__virus_host_epi_start__i ON public.epitope_11070_polyprotein USING btree (taxon_id, host_taxon_id, epi_annotation_start) WITH (fillfactor='100');


--
-- Name: epi_11070_polyprotein__virus_host_epi_stop__i; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11070_polyprotein__virus_host_epi_stop__i ON public.epitope_11070_polyprotein USING btree (taxon_id, host_taxon_id, epi_annotation_stop) WITH (fillfactor='100');


--
-- Name: epi_11070_polyprotein__virus_host_is_linear__i; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11070_polyprotein__virus_host_is_linear__i ON public.epitope_11070_polyprotein USING btree (taxon_id, host_taxon_id, is_linear) WITH (fillfactor='100');


--
-- Name: epi_11070_polyprotein__virus_host_mhc_allele__i; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11070_polyprotein__virus_host_mhc_allele__i ON public.epitope_11070_polyprotein USING btree (taxon_id, host_taxon_id, mhc_allele) WITH (fillfactor='100');


--
-- Name: epi_11070_polyprotein__virus_host_product__i; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11070_polyprotein__virus_host_product__i ON public.epitope_11070_polyprotein USING btree (taxon_id, host_taxon_id, product) WITH (fillfactor='100');


--
-- Name: epi_11070_polyprotein__virus_host_resp_freq__i; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11070_polyprotein__virus_host_resp_freq__i ON public.epitope_11070_polyprotein USING btree (taxon_id, host_taxon_id, response_frequency_pos) WITH (fillfactor='100');


--
-- Name: epi_11070_polyprotein__virus_taxon_and_host_taxon_id__i; Type: INDEX; Schema: public; Owner: geco
--

CREATE INDEX epi_11070_polyprotein__virus_taxon_and_host_taxon_id__i ON public.epitope_11070_polyprotein USING btree (taxon_id, host_taxon_id) WITH (fillfactor='100');
