...
-- MATERIALIZED VIEW AND INDEXES FOR VIRUS 11069 AND PROTEIN sfRNA1
CREATE MATERIALIZED VIEW public.epitope_11069_sfrna1
    TABLESPACE default_ts
AS
 SELECT DISTINCT epi.iedb_epitope_id,
    epi.epitope_iri,
...
ALTER TABLE public.epitope_11069_sfrna1
    OWNER TO geco;

CREATE INDEX epi_11069_sfrna1__cell_type__idx
    ON public.epitope_11069_sfrna1 USING btree
    ((cell_type::text) COLLATE pg_catalog."default")
    WITH (FILLFACTOR=100)
    TABLESPACE default_ts;
CREATE INDEX epi_11069_sfrna1__epi_annotation_start__idx
    ON public.epitope_11069_sfrna1 USING btree
    (epi_annotation_start)
    WITH (FILLFACTOR=100)
    TABLESPACE default_ts;
CREATE INDEX epi_11069_sfrna1__epi_annotation_stop__idx
    ON public.epitope_11069_sfrna1 USING btree
    (epi_annotation_stop)
    WITH (FILLFACTOR=100)
    TABLESPACE default_ts;
CREATE INDEX epi_11069_sfrna1__epi_frag_annotation_start__i
    ON public.epitope_11069_sfrna1 USING btree
    (epi_frag_annotation_start)
    WITH (FILLFACTOR=100)
    TABLESPACE default_ts;
CREATE INDEX epi_11069_sfrna1__epi_frag_annotation_stop__id
    ON public.epitope_11069_sfrna1 USING btree
    (epi_frag_annotation_stop)
    WITH (FILLFACTOR=100)
    TABLESPACE default_ts;
CREATE INDEX epi_11069_sfrna1__host_taxon_id__idx
    ON public.epitope_11069_sfrna1 USING btree
    (host_taxon_id)
    WITH (FILLFACTOR=100)
    TABLESPACE default_ts;
CREATE INDEX epi_11069_sfrna1__host_taxon_name_lower__idx
    ON public.epitope_11069_sfrna1 USING btree
    (lower(host_taxon_name::text) COLLATE pg_catalog."default")
    WITH (FILLFACTOR=100)
    TABLESPACE default_ts;
CREATE INDEX epi_11069_sfrna1__iedb_epitope_id__idx
    ON public.epitope_11069_sfrna1 USING btree
    (iedb_epitope_id)
    WITH (FILLFACTOR=100)
    TABLESPACE default_ts;
CREATE INDEX epi_11069_sfrna1__is_linear__idx
    ON public.epitope_11069_sfrna1 USING btree
    (is_linear)
    WITH (FILLFACTOR=100)
    TABLESPACE default_ts;
CREATE INDEX epi_11069_sfrna1__mhc_allele__idx
    ON public.epitope_11069_sfrna1 USING btree
    ((mhc_allele::text) COLLATE pg_catalog."default")
    WITH (FILLFACTOR=100)
    TABLESPACE default_ts;
CREATE INDEX epi_11069_sfrna1__mhc_class_lower__idx
    ON public.epitope_11069_sfrna1 USING btree
    (lower(mhc_class::text) COLLATE pg_catalog."default")
    WITH (FILLFACTOR=100)
    TABLESPACE default_ts;
CREATE INDEX epi_11069_sfrna1__product_lower__idx
    ON public.epitope_11069_sfrna1 USING btree
    (lower(product::text) COLLATE pg_catalog."default")
    WITH (FILLFACTOR=100)
    TABLESPACE default_ts;
CREATE INDEX epi_11069_sfrna1__response_frequency_pos__idx
    ON public.epitope_11069_sfrna1 USING btree
    (response_frequency_pos)
    WITH (FILLFACTOR=100)
    TABLESPACE default_ts;
CREATE INDEX epi_11069_sfrna1__sequence_aa_alternative__idx
    ON public.epitope_11069_sfrna1 USING btree
    ((sequence_aa_alternative::text) COLLATE pg_catalog."default")
    WITH (FILLFACTOR=100)
    TABLESPACE default_ts;
CREATE INDEX epi_11069_sfrna1__sequence_aa_original__idx
    ON public.epitope_11069_sfrna1 USING btree
    ((sequence_aa_original::text) COLLATE pg_catalog."default")
    WITH (FILLFACTOR=100)
    TABLESPACE default_ts;
CREATE INDEX epi_11069_sfrna1__start_aa_original__idx
    ON public.epitope_11069_sfrna1 USING btree
    (start_aa_original)
    WITH (FILLFACTOR=100)
    TABLESPACE default_ts;
CREATE INDEX epi_11069_sfrna1__taxon_id__idx
    ON public.epitope_11069_sfrna1 USING btree
    (taxon_id)
    WITH (FILLFACTOR=100)
    TABLESPACE default_ts;
CREATE INDEX epi_11069_sfrna1__taxon_name_lower__idx
    ON public.epitope_11069_sfrna1 USING btree
    (lower(taxon_name::text) COLLATE pg_catalog."default")
    WITH (FILLFACTOR=100)
    TABLESPACE default_ts;
CREATE INDEX epi_11069_sfrna1__variant_aa_length__idx
    ON public.epitope_11069_sfrna1 USING btree
    (variant_aa_length)
    WITH (FILLFACTOR=100)
    TABLESPACE default_ts;
CREATE INDEX epi_11069_sfrna1__variant_aa_type__idx
    ON public.epitope_11069_sfrna1 USING btree
    ((variant_aa_type::text) COLLATE pg_catalog."default")
    WITH (FILLFACTOR=100)
    TABLESPACE default_ts;
CREATE INDEX epi_11069_sfrna1__virus_taxon_and_host_taxon_id__i
    ON public.epitope_11069_sfrna1 USING btree
    (taxon_id, host_taxon_id)
    WITH (FILLFACTOR=100)
    TABLESPACE default_ts;
CREATE INDEX epi_11069_sfrna1__virus_host_cell_type__i
    ON public.epitope_11069_sfrna1 USING btree
    (taxon_id, host_taxon_id, cell_type COLLATE pg_catalog."default")
    WITH (FILLFACTOR=100)
    TABLESPACE default_ts;
CREATE INDEX epi_11069_sfrna1__virus_host_epi_start__i
    ON public.epitope_11069_sfrna1 USING btree
    (taxon_id, host_taxon_id, epi_annotation_start)
    WITH (FILLFACTOR=100)
    TABLESPACE default_ts;
CREATE INDEX epi_11069_sfrna1__virus_host_epi_stop__i
    ON public.epitope_11069_sfrna1 USING btree
    (taxon_id, host_taxon_id, epi_annotation_stop)
    WITH (FILLFACTOR=100)
    TABLESPACE default_ts;
CREATE INDEX epi_11069_sfrna1__virus_host_is_linear__i
    ON public.epitope_11069_sfrna1 USING btree
    (taxon_id, host_taxon_id, is_linear)
    WITH (FILLFACTOR=100)
    TABLESPACE default_ts;
CREATE INDEX epi_11069_sfrna1__virus_host_mhc_allele__i
    ON public.epitope_11069_sfrna1 USING btree
    (taxon_id, host_taxon_id, mhc_allele COLLATE pg_catalog."default")
    WITH (FILLFACTOR=100)
    TABLESPACE default_ts;
CREATE INDEX epi_11069_sfrna1__virus_host_product__i
    ON public.epitope_11069_sfrna1 USING btree
    (taxon_id, host_taxon_id, product COLLATE pg_catalog."default")
    WITH (FILLFACTOR=100)
    TABLESPACE default_ts;
CREATE INDEX epi_11069_sfrna1__virus_host_resp_freq__i
    ON public.epitope_11069_sfrna1 USING btree
    (taxon_id, host_taxon_id, response_frequency_pos)
    WITH (FILLFACTOR=100)
    TABLESPACE default_ts;
...
-- MATERIALIZED VIEW AND INDEXES FOR VIRUS 11069 AND PROTEIN sfRNA2
CREATE MATERIALIZED VIEW public.epitope_11069_sfrna2
    TABLESPACE default_ts
AS
 SELECT DISTINCT epi.iedb_epitope_id,
    epi.epitope_iri,
...
ALTER TABLE public.epitope_11069_sfrna2
    OWNER TO geco;

CREATE INDEX epi_11069_sfrna2__cell_type__idx
    ON public.epitope_11069_sfrna2 USING btree
    ((cell_type::text) COLLATE pg_catalog."default")
    WITH (FILLFACTOR=100)
    TABLESPACE default_ts;
CREATE INDEX epi_11069_sfrna2__epi_annotation_start__idx
    ON public.epitope_11069_sfrna2 USING btree
    (epi_annotation_start)
    WITH (FILLFACTOR=100)
    TABLESPACE default_ts;
CREATE INDEX epi_11069_sfrna2__epi_annotation_stop__idx
    ON public.epitope_11069_sfrna2 USING btree
    (epi_annotation_stop)
    WITH (FILLFACTOR=100)
    TABLESPACE default_ts;
CREATE INDEX epi_11069_sfrna2__epi_frag_annotation_start__i
    ON public.epitope_11069_sfrna2 USING btree
    (epi_frag_annotation_start)
    WITH (FILLFACTOR=100)
    TABLESPACE default_ts;
CREATE INDEX epi_11069_sfrna2__epi_frag_annotation_stop__id
    ON public.epitope_11069_sfrna2 USING btree
    (epi_frag_annotation_stop)
    WITH (FILLFACTOR=100)
    TABLESPACE default_ts;
CREATE INDEX epi_11069_sfrna2__host_taxon_id__idx
    ON public.epitope_11069_sfrna2 USING btree
    (host_taxon_id)
    WITH (FILLFACTOR=100)
    TABLESPACE default_ts;
CREATE INDEX epi_11069_sfrna2__host_taxon_name_lower__idx
    ON public.epitope_11069_sfrna2 USING btree
    (lower(host_taxon_name::text) COLLATE pg_catalog."default")
    WITH (FILLFACTOR=100)
    TABLESPACE default_ts;
CREATE INDEX epi_11069_sfrna2__iedb_epitope_id__idx
    ON public.epitope_11069_sfrna2 USING btree
    (iedb_epitope_id)
    WITH (FILLFACTOR=100)
    TABLESPACE default_ts;
CREATE INDEX epi_11069_sfrna2__is_linear__idx
    ON public.epitope_11069_sfrna2 USING btree
    (is_linear)
    WITH (FILLFACTOR=100)
    TABLESPACE default_ts;
CREATE INDEX epi_11069_sfrna2__mhc_allele__idx
    ON public.epitope_11069_sfrna2 USING btree
    ((mhc_allele::text) COLLATE pg_catalog."default")
    WITH (FILLFACTOR=100)
    TABLESPACE default_ts;
CREATE INDEX epi_11069_sfrna2__mhc_class_lower__idx
    ON public.epitope_11069_sfrna2 USING btree
    (lower(mhc_class::text) COLLATE pg_catalog."default")
    WITH (FILLFACTOR=100)
    TABLESPACE default_ts;
CREATE INDEX epi_11069_sfrna2__product_lower__idx
    ON public.epitope_11069_sfrna2 USING btree
    (lower(product::text) COLLATE pg_catalog."default")
    WITH (FILLFACTOR=100)
    TABLESPACE default_ts;
CREATE INDEX epi_11069_sfrna2__response_frequency_pos__idx
    ON public.epitope_11069_sfrna2 USING btree
    (response_frequency_pos)
    WITH (FILLFACTOR=100)
    TABLESPACE default_ts;
CREATE INDEX epi_11069_sfrna2__sequence_aa_alternative__idx
    ON public.epitope_11069_sfrna2 USING btree
    ((sequence_aa_alternative::text) COLLATE pg_catalog."default")
    WITH (FILLFACTOR=100)
    TABLESPACE default_ts;
CREATE INDEX epi_11069_sfrna2__sequence_aa_original__idx
    ON public.epitope_11069_sfrna2 USING btree
    ((sequence_aa_original::text) COLLATE pg_catalog."default")
    WITH (FILLFACTOR=100)
    TABLESPACE default_ts;
CREATE INDEX epi_11069_sfrna2__start_aa_original__idx
    ON public.epitope_11069_sfrna2 USING btree
    (start_aa_original)
    WITH (FILLFACTOR=100)
    TABLESPACE default_ts;
CREATE INDEX epi_11069_sfrna2__taxon_id__idx
    ON public.epitope_11069_sfrna2 USING btree
    (taxon_id)
    WITH (FILLFACTOR=100)
    TABLESPACE default_ts;
CREATE INDEX epi_11069_sfrna2__taxon_name_lower__idx
    ON public.epitope_11069_sfrna2 USING btree
    (lower(taxon_name::text) COLLATE pg_catalog."default")
    WITH (FILLFACTOR=100)
    TABLESPACE default_ts;
CREATE INDEX epi_11069_sfrna2__variant_aa_length__idx
    ON public.epitope_11069_sfrna2 USING btree
    (variant_aa_length)
    WITH (FILLFACTOR=100)
    TABLESPACE default_ts;
CREATE INDEX epi_11069_sfrna2__variant_aa_type__idx
    ON public.epitope_11069_sfrna2 USING btree
    ((variant_aa_type::text) COLLATE pg_catalog."default")
    WITH (FILLFACTOR=100)
    TABLESPACE default_ts;
CREATE INDEX epi_11069_sfrna2__virus_taxon_and_host_taxon_id__i
    ON public.epitope_11069_sfrna2 USING btree
    (taxon_id, host_taxon_id)
    WITH (FILLFACTOR=100)
    TABLESPACE default_ts;
CREATE INDEX epi_11069_sfrna2__virus_host_cell_type__i
    ON public.epitope_11069_sfrna2 USING btree
    (taxon_id, host_taxon_id, cell_type COLLATE pg_catalog."default")
    WITH (FILLFACTOR=100)
    TABLESPACE default_ts;
CREATE INDEX epi_11069_sfrna2__virus_host_epi_start__i
    ON public.epitope_11069_sfrna2 USING btree
    (taxon_id, host_taxon_id, epi_annotation_start)
    WITH (FILLFACTOR=100)
    TABLESPACE default_ts;
CREATE INDEX epi_11069_sfrna2__virus_host_epi_stop__i
    ON public.epitope_11069_sfrna2 USING btree
    (taxon_id, host_taxon_id, epi_annotation_stop)
    WITH (FILLFACTOR=100)
    TABLESPACE default_ts;
CREATE INDEX epi_11069_sfrna2__virus_host_is_linear__i
    ON public.epitope_11069_sfrna2 USING btree
    (taxon_id, host_taxon_id, is_linear)
    WITH (FILLFACTOR=100)
    TABLESPACE default_ts;
CREATE INDEX epi_11069_sfrna2__virus_host_mhc_allele__i
    ON public.epitope_11069_sfrna2 USING btree
    (taxon_id, host_taxon_id, mhc_allele COLLATE pg_catalog."default")
    WITH (FILLFACTOR=100)
    TABLESPACE default_ts;
CREATE INDEX epi_11069_sfrna2__virus_host_product__i
    ON public.epitope_11069_sfrna2 USING btree
    (taxon_id, host_taxon_id, product COLLATE pg_catalog."default")
    WITH (FILLFACTOR=100)
    TABLESPACE default_ts;
CREATE INDEX epi_11069_sfrna2__virus_host_resp_freq__i
    ON public.epitope_11069_sfrna2 USING btree
    (taxon_id, host_taxon_id, response_frequency_pos)
    WITH (FILLFACTOR=100)
    TABLESPACE default_ts;
...
-- MATERIALIZED VIEW AND INDEXES FOR VIRUS 11069 AND PROTEIN sfRNA3
CREATE MATERIALIZED VIEW public.epitope_11069_sfrna3
    TABLESPACE default_ts
AS
 SELECT DISTINCT epi.iedb_epitope_id,
    epi.epitope_iri,
...
ALTER TABLE public.epitope_11069_sfrna3
    OWNER TO geco;

CREATE INDEX epi_11069_sfrna3__cell_type__idx
    ON public.epitope_11069_sfrna3 USING btree
    ((cell_type::text) COLLATE pg_catalog."default")
    WITH (FILLFACTOR=100)
    TABLESPACE default_ts;
CREATE INDEX epi_11069_sfrna3__epi_annotation_start__idx
    ON public.epitope_11069_sfrna3 USING btree
    (epi_annotation_start)
    WITH (FILLFACTOR=100)
    TABLESPACE default_ts;
CREATE INDEX epi_11069_sfrna3__epi_annotation_stop__idx
    ON public.epitope_11069_sfrna3 USING btree
    (epi_annotation_stop)
    WITH (FILLFACTOR=100)
    TABLESPACE default_ts;
CREATE INDEX epi_11069_sfrna3__epi_frag_annotation_start__i
    ON public.epitope_11069_sfrna3 USING btree
    (epi_frag_annotation_start)
    WITH (FILLFACTOR=100)
    TABLESPACE default_ts;
CREATE INDEX epi_11069_sfrna3__epi_frag_annotation_stop__id
    ON public.epitope_11069_sfrna3 USING btree
    (epi_frag_annotation_stop)
    WITH (FILLFACTOR=100)
    TABLESPACE default_ts;
CREATE INDEX epi_11069_sfrna3__host_taxon_id__idx
    ON public.epitope_11069_sfrna3 USING btree
    (host_taxon_id)
    WITH (FILLFACTOR=100)
    TABLESPACE default_ts;
CREATE INDEX epi_11069_sfrna3__host_taxon_name_lower__idx
    ON public.epitope_11069_sfrna3 USING btree
    (lower(host_taxon_name::text) COLLATE pg_catalog."default")
    WITH (FILLFACTOR=100)
    TABLESPACE default_ts;
CREATE INDEX epi_11069_sfrna3__iedb_epitope_id__idx
    ON public.epitope_11069_sfrna3 USING btree
    (iedb_epitope_id)
    WITH (FILLFACTOR=100)
    TABLESPACE default_ts;
CREATE INDEX epi_11069_sfrna3__is_linear__idx
    ON public.epitope_11069_sfrna3 USING btree
    (is_linear)
    WITH (FILLFACTOR=100)
    TABLESPACE default_ts;
CREATE INDEX epi_11069_sfrna3__mhc_allele__idx
    ON public.epitope_11069_sfrna3 USING btree
    ((mhc_allele::text) COLLATE pg_catalog."default")
    WITH (FILLFACTOR=100)
    TABLESPACE default_ts;
CREATE INDEX epi_11069_sfrna3__mhc_class_lower__idx
    ON public.epitope_11069_sfrna3 USING btree
    (lower(mhc_class::text) COLLATE pg_catalog."default")
    WITH (FILLFACTOR=100)
    TABLESPACE default_ts;
CREATE INDEX epi_11069_sfrna3__product_lower__idx
    ON public.epitope_11069_sfrna3 USING btree
    (lower(product::text) COLLATE pg_catalog."default")
    WITH (FILLFACTOR=100)
    TABLESPACE default_ts;
CREATE INDEX epi_11069_sfrna3__response_frequency_pos__idx
    ON public.epitope_11069_sfrna3 USING btree
    (response_frequency_pos)
    WITH (FILLFACTOR=100)
    TABLESPACE default_ts;
CREATE INDEX epi_11069_sfrna3__sequence_aa_alternative__idx
    ON public.epitope_11069_sfrna3 USING btree
    ((sequence_aa_alternative::text) COLLATE pg_catalog."default")
    WITH (FILLFACTOR=100)
    TABLESPACE default_ts;
CREATE INDEX epi_11069_sfrna3__sequence_aa_original__idx
    ON public.epitope_11069_sfrna3 USING btree
    ((sequence_aa_original::text) COLLATE pg_catalog."default")
    WITH (FILLFACTOR=100)
    TABLESPACE default_ts;
CREATE INDEX epi_11069_sfrna3__start_aa_original__idx
    ON public.epitope_11069_sfrna3 USING btree
    (start_aa_original)
    WITH (FILLFACTOR=100)
    TABLESPACE default_ts;
CREATE INDEX epi_11069_sfrna3__taxon_id__idx
    ON public.epitope_11069_sfrna3 USING btree
    (taxon_id)
    WITH (FILLFACTOR=100)
    TABLESPACE default_ts;
CREATE INDEX epi_11069_sfrna3__taxon_name_lower__idx
    ON public.epitope_11069_sfrna3 USING btree
    (lower(taxon_name::text) COLLATE pg_catalog."default")
    WITH (FILLFACTOR=100)
    TABLESPACE default_ts;
CREATE INDEX epi_11069_sfrna3__variant_aa_length__idx
    ON public.epitope_11069_sfrna3 USING btree
    (variant_aa_length)
    WITH (FILLFACTOR=100)
    TABLESPACE default_ts;
CREATE INDEX epi_11069_sfrna3__variant_aa_type__idx
    ON public.epitope_11069_sfrna3 USING btree
    ((variant_aa_type::text) COLLATE pg_catalog."default")
    WITH (FILLFACTOR=100)
    TABLESPACE default_ts;
CREATE INDEX epi_11069_sfrna3__virus_taxon_and_host_taxon_id__i
    ON public.epitope_11069_sfrna3 USING btree
    (taxon_id, host_taxon_id)
    WITH (FILLFACTOR=100)
    TABLESPACE default_ts;
CREATE INDEX epi_11069_sfrna3__virus_host_cell_type__i
    ON public.epitope_11069_sfrna3 USING btree
    (taxon_id, host_taxon_id, cell_type COLLATE pg_catalog."default")
    WITH (FILLFACTOR=100)
    TABLESPACE default_ts;
CREATE INDEX epi_11069_sfrna3__virus_host_epi_start__i
    ON public.epitope_11069_sfrna3 USING btree
    (taxon_id, host_taxon_id, epi_annotation_start)
    WITH (FILLFACTOR=100)
    TABLESPACE default_ts;
CREATE INDEX epi_11069_sfrna3__virus_host_epi_stop__i
    ON public.epitope_11069_sfrna3 USING btree
    (taxon_id, host_taxon_id, epi_annotation_stop)
    WITH (FILLFACTOR=100)
    TABLESPACE default_ts;
CREATE INDEX epi_11069_sfrna3__virus_host_is_linear__i
    ON public.epitope_11069_sfrna3 USING btree
    (taxon_id, host_taxon_id, is_linear)
    WITH (FILLFACTOR=100)
    TABLESPACE default_ts;
CREATE INDEX epi_11069_sfrna3__virus_host_mhc_allele__i
    ON public.epitope_11069_sfrna3 USING btree
    (taxon_id, host_taxon_id, mhc_allele COLLATE pg_catalog."default")
    WITH (FILLFACTOR=100)
    TABLESPACE default_ts;
CREATE INDEX epi_11069_sfrna3__virus_host_product__i
    ON public.epitope_11069_sfrna3 USING btree
    (taxon_id, host_taxon_id, product COLLATE pg_catalog."default")
    WITH (FILLFACTOR=100)
    TABLESPACE default_ts;
CREATE INDEX epi_11069_sfrna3__virus_host_resp_freq__i
    ON public.epitope_11069_sfrna3 USING btree
    (taxon_id, host_taxon_id, response_frequency_pos)
    WITH (FILLFACTOR=100)
    TABLESPACE default_ts;
...
-- MATERIALIZED VIEW AND INDEXES FOR VIRUS 11069 AND PROTEIN sfRNA4
CREATE MATERIALIZED VIEW public.epitope_11069_sfrna4
    TABLESPACE default_ts
AS
 SELECT DISTINCT epi.iedb_epitope_id,
    epi.epitope_iri,
...
ALTER TABLE public.epitope_11069_sfrna4
    OWNER TO geco;

CREATE INDEX epi_11069_sfrna4__cell_type__idx
    ON public.epitope_11069_sfrna4 USING btree
    ((cell_type::text) COLLATE pg_catalog."default")
    WITH (FILLFACTOR=100)
    TABLESPACE default_ts;
CREATE INDEX epi_11069_sfrna4__epi_annotation_start__idx
    ON public.epitope_11069_sfrna4 USING btree
    (epi_annotation_start)
    WITH (FILLFACTOR=100)
    TABLESPACE default_ts;
CREATE INDEX epi_11069_sfrna4__epi_annotation_stop__idx
    ON public.epitope_11069_sfrna4 USING btree
    (epi_annotation_stop)
    WITH (FILLFACTOR=100)
    TABLESPACE default_ts;
CREATE INDEX epi_11069_sfrna4__epi_frag_annotation_start__i
    ON public.epitope_11069_sfrna4 USING btree
    (epi_frag_annotation_start)
    WITH (FILLFACTOR=100)
    TABLESPACE default_ts;
CREATE INDEX epi_11069_sfrna4__epi_frag_annotation_stop__id
    ON public.epitope_11069_sfrna4 USING btree
    (epi_frag_annotation_stop)
    WITH (FILLFACTOR=100)
    TABLESPACE default_ts;
CREATE INDEX epi_11069_sfrna4__host_taxon_id__idx
    ON public.epitope_11069_sfrna4 USING btree
    (host_taxon_id)
    WITH (FILLFACTOR=100)
    TABLESPACE default_ts;
CREATE INDEX epi_11069_sfrna4__host_taxon_name_lower__idx
    ON public.epitope_11069_sfrna4 USING btree
    (lower(host_taxon_name::text) COLLATE pg_catalog."default")
    WITH (FILLFACTOR=100)
    TABLESPACE default_ts;
CREATE INDEX epi_11069_sfrna4__iedb_epitope_id__idx
    ON public.epitope_11069_sfrna4 USING btree
    (iedb_epitope_id)
    WITH (FILLFACTOR=100)
    TABLESPACE default_ts;
CREATE INDEX epi_11069_sfrna4__is_linear__idx
    ON public.epitope_11069_sfrna4 USING btree
    (is_linear)
    WITH (FILLFACTOR=100)
    TABLESPACE default_ts;
CREATE INDEX epi_11069_sfrna4__mhc_allele__idx
    ON public.epitope_11069_sfrna4 USING btree
    ((mhc_allele::text) COLLATE pg_catalog."default")
    WITH (FILLFACTOR=100)
    TABLESPACE default_ts;
CREATE INDEX epi_11069_sfrna4__mhc_class_lower__idx
    ON public.epitope_11069_sfrna4 USING btree
    (lower(mhc_class::text) COLLATE pg_catalog."default")
    WITH (FILLFACTOR=100)
    TABLESPACE default_ts;
CREATE INDEX epi_11069_sfrna4__product_lower__idx
    ON public.epitope_11069_sfrna4 USING btree
    (lower(product::text) COLLATE pg_catalog."default")
    WITH (FILLFACTOR=100)
    TABLESPACE default_ts;
CREATE INDEX epi_11069_sfrna4__response_frequency_pos__idx
    ON public.epitope_11069_sfrna4 USING btree
    (response_frequency_pos)
    WITH (FILLFACTOR=100)
    TABLESPACE default_ts;
CREATE INDEX epi_11069_sfrna4__sequence_aa_alternative__idx
    ON public.epitope_11069_sfrna4 USING btree
    ((sequence_aa_alternative::text) COLLATE pg_catalog."default")
    WITH (FILLFACTOR=100)
    TABLESPACE default_ts;
CREATE INDEX epi_11069_sfrna4__sequence_aa_original__idx
    ON public.epitope_11069_sfrna4 USING btree
    ((sequence_aa_original::text) COLLATE pg_catalog."default")
    WITH (FILLFACTOR=100)
    TABLESPACE default_ts;
CREATE INDEX epi_11069_sfrna4__start_aa_original__idx
    ON public.epitope_11069_sfrna4 USING btree
    (start_aa_original)
    WITH (FILLFACTOR=100)
    TABLESPACE default_ts;
CREATE INDEX epi_11069_sfrna4__taxon_id__idx
    ON public.epitope_11069_sfrna4 USING btree
    (taxon_id)
    WITH (FILLFACTOR=100)
    TABLESPACE default_ts;
CREATE INDEX epi_11069_sfrna4__taxon_name_lower__idx
    ON public.epitope_11069_sfrna4 USING btree
    (lower(taxon_name::text) COLLATE pg_catalog."default")
    WITH (FILLFACTOR=100)
    TABLESPACE default_ts;
CREATE INDEX epi_11069_sfrna4__variant_aa_length__idx
    ON public.epitope_11069_sfrna4 USING btree
    (variant_aa_length)
    WITH (FILLFACTOR=100)
    TABLESPACE default_ts;
CREATE INDEX epi_11069_sfrna4__variant_aa_type__idx
    ON public.epitope_11069_sfrna4 USING btree
    ((variant_aa_type::text) COLLATE pg_catalog."default")
    WITH (FILLFACTOR=100)
    TABLESPACE default_ts;
CREATE INDEX epi_11069_sfrna4__virus_taxon_and_host_taxon_id__i
    ON public.epitope_11069_sfrna4 USING btree
    (taxon_id, host_taxon_id)
    WITH (FILLFACTOR=100)
    TABLESPACE default_ts;
CREATE INDEX epi_11069_sfrna4__virus_host_cell_type__i
    ON public.epitope_11069_sfrna4 USING btree
    (taxon_id, host_taxon_id, cell_type COLLATE pg_catalog."default")
    WITH (FILLFACTOR=100)
    TABLESPACE default_ts;
CREATE INDEX epi_11069_sfrna4__virus_host_epi_start__i
    ON public.epitope_11069_sfrna4 USING btree
    (taxon_id, host_taxon_id, epi_annotation_start)
    WITH (FILLFACTOR=100)
    TABLESPACE default_ts;
CREATE INDEX epi_11069_sfrna4__virus_host_epi_stop__i
    ON public.epitope_11069_sfrna4 USING btree
    (taxon_id, host_taxon_id, epi_annotation_stop)
    WITH (FILLFACTOR=100)
    TABLESPACE default_ts;
CREATE INDEX epi_11069_sfrna4__virus_host_is_linear__i
    ON public.epitope_11069_sfrna4 USING btree
    (taxon_id, host_taxon_id, is_linear)
    WITH (FILLFACTOR=100)
    TABLESPACE default_ts;
CREATE INDEX epi_11069_sfrna4__virus_host_mhc_allele__i
    ON public.epitope_11069_sfrna4 USING btree
    (taxon_id, host_taxon_id, mhc_allele COLLATE pg_catalog."default")
    WITH (FILLFACTOR=100)
    TABLESPACE default_ts;
CREATE INDEX epi_11069_sfrna4__virus_host_product__i
    ON public.epitope_11069_sfrna4 USING btree
    (taxon_id, host_taxon_id, product COLLATE pg_catalog."default")
    WITH (FILLFACTOR=100)
    TABLESPACE default_ts;
CREATE INDEX epi_11069_sfrna4__virus_host_resp_freq__i
    ON public.epitope_11069_sfrna4 USING btree
    (taxon_id, host_taxon_id, response_frequency_pos)
    WITH (FILLFACTOR=100)
    TABLESPACE default_ts;
